...
"Copyright &copy; 2011-YYYY The MavrodiCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About MavrodiCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>MavrodiCoin</b> version", 0));
