...
uint256 hashGenesisBlock("0x00000800c651632573a05dc33731031d399dc6b159ac4ecad536fcc45cdbb721");
...
static const int64 nTargetSpacing = 3 * 60; // MavrodiCoin: 60 seconds
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
      ...
      //vMerkleTree: 3f66108684400d84e2ffb528360d534fa19ecaf47c7c4c2ca1d1352ec4a351ad
        ...
        // Genesis block
        const char* pszTimestamp = "Mavrodi";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x4200e0967eab2140742f10d56f7b0e1635c808dbb14db94c274b1d7e29f5eaf5"));
        block.print();
